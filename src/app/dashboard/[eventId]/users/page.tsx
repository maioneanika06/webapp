...
export default function UsersPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            {!activeEvent ? (
                <div className="backdrop-blur-xl bg-white/[0.02] border border-amber-500/20 rounded-2xl p-12 text-center">
                    ...
                    <p className="text-amber-300/60 font-medium">No Active Event</p>
                    <p className="text-white/30 text-sm mt-1">Go to the Overview page to create or activate an event</p>
                </div>
            ) : (
                <>
