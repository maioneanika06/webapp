...
export default function EventOverview() {
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            {/* Event Details Card */}
            <div className="bg-white border border-purple-800/25 rounded-2xl p-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <div className={`w-12 h-12 rounded-xl border flex items-center justify-center ${activeEvent.status === 'ACTIVE' ? 'bg-emerald-50 border-purple-800/25' : 'bg-slate-50 border-purple-800/25'}`}>
